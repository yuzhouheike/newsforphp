...
<head>
    ...
    <title>lewanews Admin DashBoard</title>
    ...
    <!-- Timeline CSS -->
    <link href="{{ asset('css/dist/css/timeline.css')}}" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="{{ asset('css/dist/css/sb-admin-2.css')}}" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="{{ asset('css/bower_components/morrisjs/morris.css')}}" rel="stylesheet">
     ...
     <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">乐蛙头条后台</a>
            </div>
            <!-- /.navbar-header -->
